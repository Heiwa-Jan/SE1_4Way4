...
public class GameBoard {
	...
	public String printBoard() {
		...
		// Einr�ckung abh�ngig von Seitenr�ndern und Koordinaten (muss manuell angepasst werden!)
		// Koordinaten -> oberer Rand (a-j)
		// -> an Feldgr��e automatisch angepasst
		buildBoard.append("    ");
	...
	/**
	 * Kopiert die aktuelle SpielSituation und gibt diese zur�ck
	 * 
	 * @return spielKopie
	 */
	...
	/**
	 * Checks if the GameBoard is currently full
